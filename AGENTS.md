...
**gstack-lite** (paste into MEDIUM sessions):
```
## Planning Discipline
...
**gstack-full** (paste into FULL sessions):
```
## Full Pipeline
...
**gstack-plan** (paste into PLAN sessions):
```
## Planning Pipeline
1. Read CLAUDE.md and understand the project context.
...
4. Save the final reviewed plan to plans/<project-slug>-plan-<date>.md in the current repo.
   Include the design doc, all review decisions, and the implementation sequence.
5. Report back: plan file path, one-paragraph summary, key decisions, recommended next step.
